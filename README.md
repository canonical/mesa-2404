...
For more information about the `gpu-2604` interface, see: [The gpu-2604 snap interface](https://ubuntu.com/frame/docs/the-gpu-2604-snap-interface) documentation.
